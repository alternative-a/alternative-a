<article>
	...
	<p>
		...
		<ul>
			<li>le dessin à main levée</li>
			<li>réajuster</li>
			<li>rogner</li>
			<li>photomontages</li>
			<li>convertir entre différents formats d'image</li>
			<li>les images animées comme les fichiers GIF et MPEG peuvent être créées en utilisant un plugin d'animation.
			<li>et d'autres tâches plus spécialisées</li>
		</ul>
		Capture d'écran:
		<br>
	...
	<p>
		...
		<ul>
		<li>sélection libre</li>
		<li>sélection rectangulaire</li>
		<li>Redimensionner et incliner</li>
		<li>gomme/gomme couleur</li>
		<li>remplissage</li>
		<li>prélèvement d'une couleur</li>
		<li>zoom/Loupe</li>
		<li>pinceau</li>
		<li>brosse</li>
		<li>aérographe</li>
